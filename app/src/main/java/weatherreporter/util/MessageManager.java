...
class MessageManager extends Handler implements Comparator<AppMessage> {
    ...
    /**
     * @return A {@link weatherreporter.util.MessageManager} instance to be used for given {@link android.app.Activity}.
     */
     ...
     *
     * @param appMsg The {@link AppMessage} added to a {@link android.view.ViewGroup} and should be removed.s
     */
